...
export const FEATURES = [
  ...
  },
  {
    icon: Dices,
    title: 'Hand Guide',
    description: 'Quick reference for poker hand rankings and starting hand strengths.',
  },
  {
    icon: Plus,
    title: 'Quick Setup',
    description: 'Start your game in seconds - just create a room and share the code.',
  },
];
